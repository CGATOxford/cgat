...
#
#   $Id: analyze_synteny.py 2781 2009-09-10 11:33:14Z andreas $
#
    ...
    for method in options.methods:
        ...
        if method == "counts":
            ...
            if method == "blocks":
                ...
                writeGFF( blocks, False, options.output_pattern_gff % "species2" )                
            ...
            outfile.write( "# Histogram of block sizes of synteny breakers in genome2.\n")
...
""")
            ...
            outfile.write("gene_total\tnsyn\tntotal\tptotal\tnsame\tpsame\tndiff\tpdiff\trsd\n" )
            outfile.write("gene_total\t%i\t%i\t%5.2f\t%i\t%5.2f\t%i\t%5.2f\t%5.2f\n" % (nassigned,
                                                                                   ntotal, float( ntotal) * 100 / nassigned,
                                                                                   ntotal_same, float( ntotal_same) * 100 / nassigned,                                                              
                                                                                   ntotal_different, float( ntotal_different) * 100 / nassigned,
