...
Example::
   ...
   python optic_annotate_clusters.py --help
...
'''
USAGE="""python optic_annotate_clusters.py [OPTIONS] < clusters > output
...
if __name__ == "__main__":
    ...
    parser = E.OptionParser( version = "%prog version: $Id: optic_annotate_clusters.py 2781 2009-09-10 11:33:14Z andreas $")
    ...
    if options.filename_interpro:
        map_id2interpro = readAnnotationInterpro( open( options.filename_interpro, "r") )
            ...
            for gene in genes:
                if gene in map_id2interpro:
                    for annotation in map_id2interpro[gene]:
                        annotations_interpro[annotation.mIdentifier] = annotation
