...
Example::
   ...
   python gpipe_assignments2pairs.py --help
...
Version: $Id: gpipe_assignments2pairs.py 2011 2008-07-04 10:40:51Z andreas $
...
def WriteEntry( query_token,
    ...
    if options.offset_key:
        export_key = string.join( map(str, ( sbjct_token, margin_sbjct_from, lgenome-margin_sbjct_to)), "_")
    else:
    ...
    if options.format == "single_fasta":           
        ...
        if global_chunk_size > options.chunk_size:
            ...
            if (not region_id) or (region_nr == 1) or not global_outfile:
                if global_outfile: global_outfile.close()
...
if __name__ == '__main__':
    ...
    parser = E.OptionParser( version = "%prog version: $Id: gpipe_assignments2pairs.py 2011 2008-07-04 10:40:51Z andreas $", usage = globals()["__doc__"] )
