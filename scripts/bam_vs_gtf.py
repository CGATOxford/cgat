...
def main( argv = None ):
    ...
    exons = GTF.readAndIndex( GTF.iterator( IOTools.openFile( options.filename_exons ) ) )
    ...
    for read in pysam_in:
        ...
        if is_spliced:
            ...
            if o3 != None:
                if o3 == 0: nspliced_exact += 1
                else: nspliced_inexact += 1
                nspliced_overrun[ max(0, overrun_offset + o3)] += 1
            if o5 != None:
                if o5 == 0: nspliced_exact += 1
                else: nspliced_inexact += 1
    ...
    outfile.write( "bases\tunspliced_overrun_counts\tspliced_overrun_counts\tspliced_underrun_counts\n" )
