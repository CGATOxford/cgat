...
parser = E.OptionParser( version = "%prog version: $Id: gpipe/liftover_predictions.py 2781 2009-09-10 11:33:14Z andreas $")
...
def ReadOffsets( infile ):
    ...
    for line in infile:
        ...
        if chr not in map_old2new: map_old2new[chr] = []
...
def GetOffset( value, breakpoints, endpoints, offsets ):
    ...
    if pos == len(breakpoints): return offsets[-1]
