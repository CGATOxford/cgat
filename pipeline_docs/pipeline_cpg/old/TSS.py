...
##################################################################################
class TSSClosest(Annotations.AnnotationSlicer, cpgTracker):
...
##################################################################################
class TSSDistanceVersusPeakVal(Annotations.AnnotationSlicer, cpgTracker):
...
##################################################################################
class TSSOverlap(Annotations.AnnotationSlicer, cpgTracker):
    ...
    def __call__(self, track, slice = None ):
        ...
        for line in open( os.path.join( resultsdir, "proximity.table" ) ):
            ...
            if line.startswith( "label" ):
                ...
                data.append( ("plots", "`plot <%(resultsdir)s/%(slice)s.png>`_" % locals() ) )
