...
.. toctree::
   ...
   scripts/cgat_galaxy_wrapper.rst
   scripts/cgat_get_options.rst
   scripts/cgat_list_dependencies.rst
   scripts/cgat_pep8_code_quality.rst
   scripts/cgat_scan_email.rst
   scripts/clusters2metrics.rst
   scripts/combine_files.rst
   scripts/contigs2random_sample.rst
   scripts/contigs2stats.rst
   scripts/counts2counts.rst
   ...
   scripts/distance2merge.rst
   scripts/ena2table.rst
   scripts/expression2distance.rst
   scripts/expression2expression.rst
   scripts/fasta2distances.rst
   scripts/fastq2summary.rst
   scripts/fastqs2fastq.rst
   scripts/formatMetagenemark.rst
   scripts/genes2genes.rst
   scripts/geo2table.rst
   ...
   scripts/tfbs2enrichment.rst
   scripts/timeseries2diffgenes.rst
   scripts/transfac2transfac.rst
   scripts/version.rst
   scripts/wig2bed.rst
