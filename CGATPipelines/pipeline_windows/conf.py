...
docsdir=os.environ.get( "SPHINX_DOCSDIR", "../src/pipeline_docs/pipeline_rnaseq" )

if not os.path.exists(docsdir):
    raise ValueError( "documentation directory '%s' not found" % docsdir )

# General information about the project.
project = u'RNASeq example'
...
def setup(app):
    app.add_config_value('METHODS', '', True)
...
METHODS = P.asList( P.PARAMS["methods" ] )
