...
class TruncateCheck(unittest.TestCase):
    ...
    def testNoOverlap(self):
        """test empty input."""
        self.assertEqual( Intervals.truncate( [(0,5), (10,15)], [(5,10)] ), [(0,5), (10,15)] )
        self.assertEqual( Intervals.truncate( [(5,10)], [(0,5), (10,15)] ), [(5,10)] )
        self.assertEqual( Intervals.truncate( [(0,5), (5,10)], [(10,15)] ), [(0,5), (5,10)] )
