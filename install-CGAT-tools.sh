...
conda install -n $CONDA_INSTALL_ENV pysam=0.11.1 pybedtools icu=58 --override-channels --channel conda-forge --channel defaults --channel r --channel bioconda --yes
