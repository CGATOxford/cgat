...
if [ "$CONDA_INSTALL_TYPE" == "cgat-scripts" ] ; then
   ...
   conda create -q -n $CONDA_INSTALL_TYPE $CONDA_INSTALL_TYPE python=$PYTHON --override-channels --channel https://conda.anaconda.org/cgat --channel defaults --channel https://conda.anaconda.org/bioconda --channel https://conda.anaconda.org/r --yes
