...
class Counts(object):
    ...
    def shuffleRows(self, i_bins, c_bins, tracks_map,  groups,
        ...
        * i_bins = np.arange of bins for initial values
        * x_bins = np.arange of bins for change values
    ...
    def outputSpikes(self, indices, tracks_map, groups,
        ...
        * min_c_bins = minimum bins for change values
        * width_c_bins = width of bins for change values
        * min_s_bins = minimum bins for size values
