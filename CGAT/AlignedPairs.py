...
# GAPSIZES2:      length of gap sizes in sequence2"""
    ...
    def Align( self, method, anchor = 0, loglevel = 1 ):
        ...
        if method == "dialign":
            ...
            seq1 = alignlib.py_makeSequence( s1 )
            seq2 = alignlib.py_makeSequence( s2 )
            ...
            seq1 = alignlib.py_makeSequence( s1 )
            seq2 = alignlib.py_makeSequence( s2 )
            alignlib.py_performIterativeAlignment( map_a2b, seq1, seq2, alignator_sw, min_score_sw )
        else:
        ...
        f = alignlib.py_AlignmentFormatExplicit( map_a2b, 
                                              alignlib.py_makeSequence( self.mSequence1),
                                              alignlib.py_makeSequence( self.mSequence2) )

        self.mMethod = method
        self.mAlignment = map_a2b
        self.mAlignedSequence1, self.mAlignedSequence2 = f.mRowAlignment, f.mColAlignment
        f = alignlib.py_AlignmentFormatEmissions( map_a2b )
