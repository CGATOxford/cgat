...
import os, sys, re, optparse, fileinput
...
def main( argv = None ):
    ...
    parser = optparse.OptionParser( version = "%prog version: $Id: script_template.py 2781 2009-09-10 11:33:14Z andreas $", usage = globals()["__doc__"] )
