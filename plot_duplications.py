...
#
#   $Id: plot_duplications.py 2782 2009-09-10 11:40:29Z andreas $
#
...
class DuplicationPlot:
    ...
    def initializePlot( self ):
        ...
        self.mTotalSize = reduce( lambda x,y: x+y, self.mMapContig2Size.values())
        ## estimated height and width of data section
        self.mDataWidth  = self.mNumEntries / 2 * self.mRadiusIncrement + self.mRadiusStart
        ...
        self.mPageHeight = self.mHeaderHeight + self.mDataHeight + self.mFooterHeight + 2 * self.mSeparator        
        ...
        self.mDataMiddleX, self.mDataMiddleY = self.mDataWidth / 2, self.mDataHeight / 2
...
##                                       stroke_width = self.mMarkerWidth / 2 )
    ...
    def writeGrid( self ):
        ...
        for contig,pos in self.contig2Position.items():
            ...
            x,y = self.getPosOnArc( angle, (self.mRadius + self.mRadiusStart) / 2)
...
if __name__ == "__main__":
    ...
    parser = optparse.OptionParser( version = "%prog version: $Id: plot_duplications.py 2782 2009-09-10 11:40:29Z andreas $", usage=USAGE)
